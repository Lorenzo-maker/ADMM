function [x_num, xdot_next] = RK4(x_expr, u_expr, xdot_expr, dt, t_end, x0, t0, u_in, options)
%
...
h = SX.sym('h');
xdot_next = Function('xdot', {x_expr, u_expr, h}, {RK4_step(x_expr, u_expr, xdot_fun, h, 'Nsteps', Nsteps)});
% opts = struct('main', false,...
%                'mex', true);
% xdot_discrete.generate('xdot_discrete.c',opts);
% mex xdot_discrete.c -largeArrayDims
