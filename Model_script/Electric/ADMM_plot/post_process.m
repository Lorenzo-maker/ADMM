...
if Nproblems > 1
    ...
    X_sol(end-1,:) = model.vehicle.bat.SOC_min + X_sol(end-1,:);
    U_sol = U_sol.*U_scale;
    Z_sol = Z_sol.*Z_scale;
else
    x_init = X(1:nx);
...
labels = {'u', 'v', 'r', 'x', 'y', 'psi', 'SOC', 'T', 'brk', 'thr', 'delta', 'Fxf', 'Fxr', 'Fyf', 'Fyr', 'Fzf', 'Fzr', 'ax', 'ay', 'gamma1', 'gamma2', 'ep', 'dt', 'trajectory'};
