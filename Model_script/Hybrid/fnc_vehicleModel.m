...
%
% Scaling factors
sys.inputs.delta_v_scaling = model.opt.delta_v_max;
%
% Inputs
...
sys.parameters.gamma2_scaling = model.vehicle.bat.Pin_max ...
    / (model.vehicle.pt2.P_max * model.vehicle.bat.eta_charge_tot);
...
% rel.module = track.fun_normtv(sys.states.alpha) / rel.sp;
% %
...
% % Traction force
% rel.pt1_Fxt_fun = Function('pt1_Fxt', ...
%     {sys.states.u_norm, sys.inputs.thr, sys.parameters.betaf, sys.inputs.brk, sys.parameters.gamma2}, ...
%     {model.vehicle.pt1.eta * (sys.inputs.thr .* sys.parameters.betaf - sys.inputs.brk .* sys.parameters.gamma2) ...
%     * rel.pt1_Pout_fun(sys.states.u_norm) ./ sys.states.u}, ...
%     {'u_norm', 'thr', 'betaf', 'brk', 'gamma2'}, {'PT1 tractive force'});
% rel.pt1_Fxt_fun = Function('pt1_Fxt', ...
%     {sys.states.u_norm, sys.inputs.thr, sys.parameters.betaf}, ...
%     {sys.inputs.thr .* sys.parameters.betaf .* model.vehicle.pt1.eta ...
%     * rel.pt1_Pout_fun(sys.states.u_norm) ./ sys.states.u}, ...
%     {'u_norm', 'thr', 'betaf'}, {'PT1 tractive force'});
% % Regenerative brake force
% rel.pt1_Fxregen_fun = Function('pt1_Fxregen', ...
%     {sys.states.u_norm, sys.inputs.brk, sys.parameters.gamma2}, ...
%     {sys.inputs.brk .* sys.parameters.gamma2 .* model.vehicle.pt1.eta ...
%     * -rel.pt1_Pout_fun(sys.states.u_norm) ./ sys.states.u}, ...
%     {'u_norm', 'brk', 'gamma2'}, {'PT1 regenerative brake force'});
%
%% PT2 e-Motor equations
%
% Reduction ratio
rel.pt2_tau_fun = Function('pt2_tau', {sys.states.u_norm}, ...
    {model.vehicle.pt2.tau_map_ratio(1) + sum(diff(model.vehicle.pt2.tau_map_ratio) ...
    .* (0.5 * (1 + tanh(atanh(0.9) / model.vehicle.pt2.delta_speed ...
    * (sys.states.u - model.vehicle.pt2.tau_map_speed(1:(end-1)))))))}, ...
...
rel.pt2_Fxt_fun = Function('pt2_Fxt', ...
    ...
    {model.vehicle.pt2.eta * (sys.parameters.betar - sys.parameters.gamma2) ...
...
rel.der_T = 1 / model.vehicle.bat.mc ...
    ...
    * rel.pt2_Pout_fun(sys.states.u_norm) - model.vehicle.bat.Pcooling);
%
% rel.der_SOC = rel.module / model.vehicle.bat.E_max ...
%     * ((model.vehicle.bat.phi * sys.inputs.brk .* sys.parameters.gamma2 * model.vehicle.bat.eta_charge_tot ...
%     - sys.inputs.thr .* sys.parameters.betar ./ model.vehicle.bat.eta_discharge_tot) ...
%     * rel.pt2_Pout_fun(sys.states.u_norm) - model.vehicle.bat.Pcooling / model.vehicle.bat.COP);
% rel.der_T = rel.module / model.vehicle.bat.mc ...
%     * ((model.vehicle.bat.phi * sys.inputs.brk * sys.parameters.gamma2 * (1 - model.vehicle.bat.eta_charge_batt) ...
%     * model.vehicle.bat.eta_charge_tot + sys.inputs.thr * sys.parameters.betar ...
%     * (1 - model.vehicle.bat.eta_discharge_batt) / model.vehicle.bat.eta_discharge_tot) ...
%     * rel.pt2_Pout_fun(sys.states.u_norm) - model.vehicle.bat.Pcooling);
% rel.der_SOC = rel.module / model.vehicle.bat.E_max ...
%     * (min(66, rel.pt2_Pout_fun(sys.states.u_norm) * model.vehicle.bat.eta_charge_tot * ...
%     sys.inputs.brk .* sys.parameters.gamma2) ...
%     - sys.inputs.thr .* sys.parameters.betar ./ model.vehicle.bat.eta_discharge_tot ...
%     * rel.pt2_Pout_fun(sys.states.u_norm) * model.vehicle.bat.eta_discharge_tot ...
%     - model.vehicle.bat.Pcooling / model.vehicle.bat.COP);
% rel.der_T = rel.module / model.vehicle.bat.mc ...
%     * ((min(66, rel.pt2_Pout_fun(sys.states.u_norm) * model.vehicle.bat.eta_charge_tot * ...
%     sys.inputs.brk .* sys.parameters.gamma2) * (1 - model.vehicle.bat.eta_charge_batt)) ...
%     + sys.inputs.thr .* sys.parameters.betar * (1 - model.vehicle.bat.eta_discharge_batt) ...
%     * rel.pt2_Pout_fun(sys.states.u_norm) - model.vehicle.bat.Pcooling);
%% Algebric equations
%
% Equations of Fx
rel.eq01 = sys.parameters.Fxf - (rel.Fxb_mech(1) ...
    + rel.pt1_Fxt_fun(sys.states.u_norm, sys.inputs.thr));
...
sys.parameters.Fxf_norm_0 = (sys.parameters.Fxf_scaling^-1) ...
    * sys.inputs.thr_0 * rel.pt1_Pout_fun(sys.states.u_norm_0) / model.opt.u_0;
...
% Battery power
% rel.bat_Pout = (model.vehicle.bat.phi * sys.inputs.brk * sys.parameters.gamma2 ...
%     * model.vehicle.bat.eta_charge_tot - sys.inputs.thr * sys.parameters.betar ...
%     ./ model.vehicle.bat.eta_discharge_tot) .* rel.pt2_Pout_fun(sys.states.u_norm) ...
%     - model.vehicle.bat.Pcooling / model.vehicle.bat.COP;
rel.bat_Pout = (sys.parameters.gamma2 ...
    * model.vehicle.bat.eta_charge_tot - sys.parameters.betar ...
    ./ model.vehicle.bat.eta_discharge_tot) .* rel.pt2_Pout_fun(sys.states.u_norm) ...
    - model.vehicle.bat.Pcooling / model.vehicle.bat.COP;
rel.bat_Pout_fun = Function('bat_Pout', ...
    {sys.states.u_norm, ...
    sys.parameters.gamma2_norm, sys.parameters.betar}, {rel.bat_Pout}, ...
    {'u_norm', 'gamma2_norm', 'betar'}, {'Battery power'});
%
% Cornering stiffness
